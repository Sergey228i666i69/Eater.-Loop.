...
- Level authoring contract для cycle metadata, single Player instance, configured bed transitions, bed target scene type, conditional respawn paths и включённых стартовых текстов.
