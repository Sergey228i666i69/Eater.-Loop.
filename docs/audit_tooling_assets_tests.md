...
- После ремонтных проходов 2026-06-23 parser-only и полный suite проходят; текущий полный suite содержит 61 тест.
...
Текущий expected result: `bash tests/run_tests.sh` завершается `OK: all tests passed (61)`.
