...
- Fridge authoring contract для feeding/code-lock/final fridge configs, typed `FeedingMinigame` scenes, food scenes, face/background, code-lock scene и final setup contract.
