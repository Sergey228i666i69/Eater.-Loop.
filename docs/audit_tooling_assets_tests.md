...
- Fridge authoring contract для feeding/code-lock/final fridge configs, typed `FeedingMinigame` scenes, typed `FinalFeedMinigame` scene, typed `FoodItem` food scenes, face/background и code-lock scene.
