...
- `res://levels/minigames/gamepad/gamepad_runtime.gd`
  ...
  - Игнорирует `confirm`, если он был зажат до старта мини-игры, пока игрок не отпустит кнопку.
  - Режимы:
...
- `GamepadRuntime` сам фильтрует подтверждение, зажатое до старта мини-игры.
- Новым мини-играм не нужно вручную хранить `confirm_was_held`/`ignore_first_accept` state.
- Если confirm выглядит "не сработавшим" сразу после открытия, проверьте, не удерживалась ли кнопка на входе в мини-игру.
