...
| Интерактивы | 5/10 | фокус, one-shot, key-source, utility paths, level authoring, trigger target/property contracts, spawner и minimal typed dependency contracts исправлены |
