...
- `light_run` остаётся активнее `walk` по bounce, foot-lift, foot-roll, arm/wrist follow-through и spine sway, но его stride/thigh-swing сужен, чтобы задняя и передняя штанины не читались отрезанными блоками; contact-times шаговых звуков сохранены на прежних 0.1375/0.4125.
