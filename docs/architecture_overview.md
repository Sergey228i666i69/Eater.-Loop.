...
- Добавлены scene-contract validators для critical NodePath/child contracts, configured trigger target/property wiring, key-door/search-key wiring и отдельные STU path contracts.
