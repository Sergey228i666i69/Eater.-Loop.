...
- `walk`/`light_run` усилены по body-bounce, leg-swing, foot-lift и arm/wrist follow-through, чтобы в игровом масштабе они не читались как почти статичный idle; шаговые contact-times сохранены прежними.
