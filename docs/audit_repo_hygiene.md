...
- `MinigameController`: стало около 632 строки + `minigame_backdrop_presenter.gd` + `minigame_prompt_visibility_coordinator.gd` + `minigame_timer_state.gd` + `gamepad_scheme_registry.gd`;
