...
- `Player`: остаётся фасадом движения/анимации/инвентаря, но state helpers уже вынесли `player_stamina_state.gd`, `player_inventory_state.gd` и `player_flashlight_charge_state.gd`;
