...
- `GameDirector`: было 1171 строка, стало около 990 строк + `game_director_death_title_presenter.gd` + `game_director_stalker_service.gd`;
