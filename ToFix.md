...
- `tests/cases/test_fridge_authoring_contracts.gd` валидирует active level feeding/code-lock/final fridge configs, включая typed `FeedingMinigame` scenes, food scenes, face/background, code-lock scene и final setup contract.
