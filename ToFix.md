...
- `tests/cases/test_fridge_authoring_contracts.gd` валидирует active level feeding/code-lock/final fridge configs, включая typed `FeedingMinigame` scenes, typed `FinalFeedMinigame` scene, food scenes, face/background и code-lock scene.
