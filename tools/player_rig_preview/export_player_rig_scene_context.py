...
LAYER_OVERLAY_COLORS: dict[str, tuple[int, int, int, int]] = {
    ...
    "MeshFrontUpperArm": (255, 120, 0, 155),
    "MeshFrontForearm": (255, 220, 0, 155),
    "MeshFrontArmSideShadow": (80, 35, 10, 180),
    ...
    "MeshBackThigh": (0, 152, 255, 165),
    "MeshBackShin": (0, 220, 255, 165),
    "VisualFrontThigh": (255, 165, 0, 160),
    "VisualFrontShin": (255, 220, 0, 160),
    "VisualFrontFoot": (255, 75, 0, 165),
    "MeshFrontThigh": (255, 165, 0, 165),
    "MeshFrontShin": (255, 220, 0, 165),
