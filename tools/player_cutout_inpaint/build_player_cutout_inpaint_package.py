...
TARGETS: dict[str, TargetSpec] = {
    ...
    "front_upper_arm": TargetSpec(
        cutout="front_upper_arm.png",
        source="player/Andry.png",
        source_crop=(0, 150, 92, 365),
        prompt_focus="complete the front upper arm as one continuous sleeve-and-upper-arm segment hidden behind the torso edge",
        mask_margin=16,
    ),
    "back_upper_arm": TargetSpec(
        cutout="back_upper_arm.png",
        source="player/Andry.png",
        source_crop=(130, 155, 224, 370),
        prompt_focus="complete the back upper arm as one continuous sleeve-and-upper-arm segment hidden behind the torso edge",
        mask_margin=16,
    ),
    "front_forearm": TargetSpec(
        cutout="front_forearm.png",
        source="player/Andry.png",
        source_crop=(0, 255, 100, 470),
        prompt_focus="complete the front forearm as one continuous skin-toned forearm segment without shirt, trouser, or torso fragments",
        mask_margin=14,
    ),
    "back_forearm": TargetSpec(
        cutout="back_forearm.png",
        source="player/Andry.png",
        source_crop=(145, 255, 224, 465),
        prompt_focus="complete the back forearm as one continuous skin-toned forearm segment without hand, shirt, trouser, or torso fragments",
        mask_margin=14,
    ),
